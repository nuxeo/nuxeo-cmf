 ...
 */
public class ClassificationCaseFolderListener implements EventListener {
    ...
    public void handleEvent(Event event) throws ClientException {
        ...
        try {
            ...
            CreateCaseFolderFilingRootUnrestricted filingRootCreator = new CreateCaseFolderFilingRootUnrestricted(
                    coreSession, doc);
