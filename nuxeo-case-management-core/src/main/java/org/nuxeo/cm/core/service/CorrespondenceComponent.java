 ...
 *
 */
public class CorrespondenceComponent extends DefaultComponent {

    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(CorrespondenceComponent.class);
    ...
    protected CorrespondenceServiceImpl service;

    @Override
    public void activate(ComponentContext context) throws Exception {
        super.activate(context);
        this.service = new CorrespondenceServiceImpl();
    }
