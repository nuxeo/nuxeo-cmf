...
public class CorrespondenceStartupHelper extends StartupHelper {

    private static final long serialVersionUID = -3606085944027894437L;

    private static final Log log = LogFactory.getLog(CorrespondenceStartupHelper.class);

    @In(create = true)
    protected transient CorrespondenceMailboxActionsBean correspMailboxActions;
