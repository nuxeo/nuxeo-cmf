 ...
 *
 */
public class CorrespondenceSecurityTestCase extends SQLRepositoryTestCase {
    ...
    public CorrespondenceSecurityTestCase() {
        super(null);
    }

    public CorrespondenceSecurityTestCase(String name) {
        super(name);
    }
