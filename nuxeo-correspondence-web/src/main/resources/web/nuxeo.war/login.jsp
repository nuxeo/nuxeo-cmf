...
<!--
 body {
  ...
  background: #000 url(<%=context%>/img/login_bg.jpg) no-repeat bottom left;
  color: #343434;
  }
...
<body style="margin:0;text-align:center;"
  ...
  <table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
    <tbody>
      <tr class="topBar">
        <td>
          <img src="<%=context%>/img/correspondence_logo.png" alt="Nuxeo Correspondence" width="224" height="36"/>
       </td>
      ...
      <ul>
            <li>
              <a onclick="window.open(this.href); return false;"
                href="http://www.nuxeo.com/en/subscription/connect?utm_source=corr&amp;utm_medium=login-page-top&amp;utm_campaign=products">
                <fmt:message bundle="${messages}" key="label.login.getSupport" />
              </a>
            </li>
            <li>
              <a onclick="window.open(this.href); return false;"
                href="http://www.nuxeo.org/discussions/index.jspa?utm_source=corr&amp;utm_medium=login-page-top&amp;utm_campaign=products">
                <fmt:message bundle="${messages}" key="label.login.forums" />
              </a>
            </li>
            <li>
              <a onclick="window.open(this.href); return false;"
                href="https://doc.nuxeo.com/display/CMDOC/Home?utm_source=corr&amp;utm_medium=login-page-top&amp;utm_campaign=products">
      ...
      <td class="news_container" align="right" valign="center">
        <% if (!request.getHeader("User-Agent").contains("Nuxeo-Selenium-Tester")) { %>
          <iframe class="block_container" style="visibility:hidden"
            ...
            src="https://www.nuxeo.com/embedded/cm-login"></iframe>
        <% } %>
      </td>
    </tr>
    <tr class="footer">
