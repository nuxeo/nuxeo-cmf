...
public interface CaseDistributionService extends Serializable {
    ...
    /**
     * Remove a case link from the mailbox. It is the duty of a listener to update the security on the case if
     * necessary.
     *
     * @param link
     */
     ...
     * @return an emptyCase
     */
    Case createEmptyCase(CoreSession session, DocumentModel caseDoc, Mailbox mailbox);

    Case createEmptyCase(CoreSession session, DocumentModel caseDoc, List<Mailbox> mailboxes);
     ...
     */
    CaseLink createDraftCaseLink(CoreSession session, Mailbox mailbox, Case envelope);

    /**
     * Throw a core event.
     *
     * @param session The session use in the event context and to get the principal.
    ...
    /**
     * This method calls {@link CaseManagementPersister} to find the parent document of a case to be created.
     *
     * @param session
    ...
    /**
     * This method calls {@link CaseManagementPersister} to find the parent document path of a case to be created.
     *
     * @param session
     * @return
     */
    ...
    /**
     * This method calls {@link CaseManagementPersister} to create a {@link Case} from the given {@link CaseItem}
     *
     * @param {@link CaseItem}
    ...
    /**
     * This method calls {@link CaseManagementPersister} to find the parent document path of a {@link CaseItem} to be
     * created.
     * 
     * @param coreSession
