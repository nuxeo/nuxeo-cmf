...
public class MailboxImpl implements Mailbox {
    ...
    public void removeParticipantList(String mailingListId) {
        try {
            ...
            if (set) {
                setPropertyValue(MailboxConstants.PARTICIPANTS_LIST_FIELD,
                        mls);
            }
        } catch (ClientException e) {
            throw new ClientRuntimeException(e);
    ...
    public void setProfiles(List<String> profiles) {
        ...
        setPropertyValue(MailboxConstants.PROFILES_FIELD,
    ...
    public String getAffiliatedMailboxId() {
        return getStringProperty(MailboxConstants.AFFILIATED_CASE_FOLDER_ID);
    }
