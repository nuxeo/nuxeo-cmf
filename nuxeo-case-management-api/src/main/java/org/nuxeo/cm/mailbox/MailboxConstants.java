...
public class MailboxConstants {
    ...
    public static final String CASE_FOLDER_DOCUMENT_TYPE = "Mailbox";

    public static final String CASE_FOLDER_FACET = "Mailbox";

    public static final String CASE_TYPE = "Case";

    public static final String CASE_FOLDER_ROOT_DOCUMENT_TYPE = "MailboxRoot";
    ...
    public static final String MAILINGLIST_CASE_FOLDER_FIELD = "mailbox";
